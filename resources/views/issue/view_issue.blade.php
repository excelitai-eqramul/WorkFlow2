                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('add.issue') }}" class="form form-vertical">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="first-name-icon">Issue Name</label>
                                            <div class="input-group input-group-merge">
                                                <input type="text" id="first-name-icon" class="form-control"
                                                    name="name" placeholder="Issue Name">
                                            </div>
                                            @error('cat_name_en')
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="first-name-icon">Issue type</label>
                                            <div class="input-group input-group-merge">
                                                <input type="text" id="first-name-icon" class="form-control"
                                                    name="type" placeholder="Issue Member">
                                            </div>
                                            @error('cat_name_bn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="first-name-icon">Issue date</label>
                                            <div class="input-group input-group-merge">
                                                <input type="date" id="first-name-icon" class="form-control"
                                                    name="date" placeholder="Issue date">
                                            </div>
                                            @error('cat_name_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="first-name-icon">Issue time</label>
                                            <div class="input-group input-group-merge">
                                                <input type="time" id="first-name-icon" class="form-control"
                                                    name="time" placeholder="Issue time">
                                            </div>
                                            @error('cat_name_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="first-name-icon">issued_by</label>
                                            <div class="input-group input-group-merge">
                                                <input type="text" id="first-name-icon" class="form-control"
                                                    name="issued_by" placeholder="issued_by">
                                            </div>
                                            @error('cat_name_en')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
